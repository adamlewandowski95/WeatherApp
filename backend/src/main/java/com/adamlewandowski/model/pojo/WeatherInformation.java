...
package com.adamlewandowski.model.pojo;
...
public class WeatherInformation implements Serializable
{
    ...
    private final static long serialVersionUID = 4060215501338895784L;
    ...
    public String toString() {
        ...
        sb.append(WeatherInformation.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("coord");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof WeatherInformation) == false) {
            return false;
        }
        WeatherInformation rhs = ((WeatherInformation) other);
